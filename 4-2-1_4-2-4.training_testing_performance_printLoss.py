...
for simufile in simu_file_list:
    ...
    os.system("python3 4-2-1_split_to_training_testing.py " + simu_path + " " + processed_simu_path + " " + simufile)
    # reformat testing data from h5ad file to txt file
    #os.system("python3 4-2-2_reformat_bulk_RNA_data.py " + processed_simu_path + " " + simufile)
    ...
    os.system("python3 4-2-2_reformat_testing_data.py " + processed_simu_path + " " + simufile)
    # training
    ...
    os.system("python3 4-2-3_training_scaden_model_printLoss.py " + train_processed_file + " " + model_folder + " " + out_loss_record)
    # testing
    ...
    os.system("python3 4-2-4_CCC_evaluation_pooledAllForOneDataset.py " + processed_simu_path + " " + simufile + " " + CCC_all_results)
    print("Completed!")

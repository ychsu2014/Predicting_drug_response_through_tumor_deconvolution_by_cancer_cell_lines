#data_path = "/home/CBBI/hsuy1/projects/drugResponse/Scaden/scaden_reproduce/data/simulated_bulk_v4_unknown_processedTest/simulation_data"
#data_path = "/home/CBBI/hsuy1/projects/drugResponse/data/SCP542_UMI_processed/simulation/by_cancerType"
#in_true_file = data_path + "/data6k_processed.h5ad"
#in_pred_file = data_path + "/data6k_prediction.txt"

#in_true_file = data_path + "/data8k_processed.h5ad"
#in_pred_file = data_path + "/data8k_prediction.txt"

#in_true_file = data_path + "/donorA_processed.h5ad"
#in_pred_file = data_path + "/donorA_prediction.txt"

#in_true_file = data_path + "/donorC_processed.h5ad"
#in_pred_file = data_path + "/donorC_prediction.txt"

#in_true_file = data_path + "/testing_Bladder_Cancer.h5ad"
#in_pred_file = data_path + "/Bladder_Cancer_prediction.txt"

#data_path = "/home/CBBI/hsuy1/projects/drugResponse/data/SCP542_UMI_processed/simulation_onlyNormalized/by_cancertypes"

#in_true_file = data_path + "/testing_Breast_Cancer_processed.h5ad"
#in_pred_file = data_path + "/Breast_Cancer_prediction.txt"

#in_true_file = data_path + "/testing_Colon_Colorectal_Cancer_processed.h5ad"
#in_pred_file = data_path + "/Colon_Colorectal_Cancer_prediction.txt"
...
in_true_file = data_path + "/testing_" + simu_name[:-5] + "_processed.h5ad"

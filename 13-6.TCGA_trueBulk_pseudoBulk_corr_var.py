true_folder = "/home/CBBI/hsuy1/projects/drugResponse/data/ICIBM_2023/TCGA/processed_data/RNA/by_cancertypes/"
true_lung_folder = "/home/CBBI/hsuy1/projects/drugResponse/data/ICIBM_2023/TCGA/processed_data/RNA/lung_cancer_all_oncoKB_19/"
pred_folder = "/home/CBBI/hsuy1/projects/drugResponse/data/ICIBM_2023/TCGA/processed_data/RNA/pseudo_bulk_RNA/quantile_normalization/"

# in_ID_cell = "/home/CBBI/hsuy1/projects/drugResponse/data/ICIBM_2023/CCLE/RNA/CCLE_all_RNA_idx_depmapID.txt"
out_file = pred_folder + "TCGA_RNA_trueBulk_pseudoBulk_corrCoef_unexpVar.txt"
...
fout.write("\t".join(["cancer_type", "sID", "correlation_coefficient", "p_value", "unexplained_variance"]) + "\n")
for pred_file in pred_files:
    cancer_type = pred_file.replace("_pseudo_bulk_norm_scaled.h5ad", "")
    print(cancer_type)
    true_file = cancer_type.replace("_","") + "_RNA_overlapped_genes_geneSubset.h5ad"
    ...
    for sID in all_sIDs:
        ...
        pred_temp_df = pred_df.loc[sID, true_df.columns]
        ...
        p_value = res[1]
        unexp_var = 1 - (res[0] ** 2)
        fout.write("\t".join([cancer_type, sID, str(corr_coef), str(p_value), str(unexp_var)]) + "\n")

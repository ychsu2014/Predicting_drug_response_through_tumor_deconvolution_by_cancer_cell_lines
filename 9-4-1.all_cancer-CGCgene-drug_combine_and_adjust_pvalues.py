in_path = "/home/CBBI/hsuy1/projects/drugResponse/data/ICIBM_2023/TCGA/processed_data/drug_score/exponential_log/CGC_lung19/"
out_file = "/home/CBBI/hsuy1/projects/drugResponse/data/ICIBM_2023/TCGA/processed_data/drug_score/exponential_log/CGC_lung19/mut_grouped_drug_prediction_t_test_p_values_CGC_all_cancer_adjusted_pvalues.txt"
file_prefix = "mut_grouped_drug_prediction_t_test_p_values_CGC_"
...
for afile in all_files:
    if file_prefix in afile:
        CGC_file_list.append(afile)

# combine all the data
all_data_lines = []
for aCGCfile in CGC_file_list:
    f = open(in_path + aCGCfile)
    lines = f.readlines()
    lines = lines[1:]
...
fout.write("\t".join(["Cancer_type", "gene", "drug", "mut_num", "wt_num", "mut_mean", "wt_mean", "mut_wt_diff", "p_value", "adj_p_value"]) + "\n")
count = 0
